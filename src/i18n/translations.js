  ...
  es: {
    ...
    simulador: {
      ...
      badges: [
        ...
        { value: "4", label: "Personas ingresadas" },
        { value: "Completo", label: "Escenario" },
      ],
      processSteps: ["Inicio", "Verificación", "Análisis", "Documentos", "Cierre"],
      chartTitle: "Ejemplo: esposa, 2 hijos y madre",
      chartHelp: "La madre queda considerada en el análisis, pero en este caso la distribución legal queda entre cónyuge e hijos.",
      segments: [
    ...
    servicios: {
      ...
      items: [
        { name: "Simulador Gratuito", price: "Gratis", body: "Calcula la distribución orientativa de tu herencia en minutos, sin costo." },
        { name: "Diagnóstico Automático", price: "$15.000", body: "Informe automático con el estado general de tu herencia." },
        { name: "Estudio Sucesorio Personalizado", price: "$50.000", body: "Revisión a fondo de tus documentos oficiales por nuestro equipo." },
        { name: "Consultoría Express", price: "$80.000", body: "Estudio personalizado + videollamada de 30 minutos con un experto." },
        { name: "Mediación Familiar y Corretaje", price: "7% de la venta", body: "Te ayudamos a llegar a acuerdo y a vender el bien a su valor justo." },
        { name: "Planificación de Legado", price: "15 UF", body: "Diseño, redacción y gestión legal de tu testamento en vida." },
        { name: "Liquidez Inmediata", price: "2% + 2%", body: "Conexión directa con fondos de inversión para vender tus derechos hereditarios." },
      ],
  ...
  en: {
    ...
    simulador: {
      ...
      badges: [
        ...
        { value: "4", label: "People entered" },
        { value: "Complete", label: "Scenario" },
      ],
      processSteps: ["Start", "Verification", "Analysis", "Documents", "Close"],
      chartTitle: "Example: wife, 2 sons, and mother",
      chartHelp: "The mother is included in the analysis, but in this case the legal distribution goes to the spouse and children.",
      segments: [
        { label: "Wife", value: 50 },
        { label: "Son 1", value: 25 },
        { label: "Son 2", value: 25 },
        { label: "Mother", value: 0 },
      ],
    ...
    servicios: {
      ...
      items: [
        { name: "Free Simulator", price: "Free", body: "Get an indicative distribution of your inheritance in minutes, at no cost." },
        { name: "Automatic Diagnosis", price: "$15.000 CLP", body: "Automated report on the general state of your inheritance." },
        { name: "Personalized Estate Study", price: "$50.000 CLP", body: "In-depth review of your official documents by our team." },
        { name: "Express Consulting", price: "$80.000 CLP", body: "Personalized study plus a 30-minute video call with an expert." },
        { name: "Family Mediation & Brokerage", price: "7% of sale", body: "We help you reach agreement and sell the asset at fair value." },
        { name: "Legacy Planning", price: "15 UF", body: "Design, drafting, and legal management of your will while you're alive." },
        { name: "Immediate Liquidity", price: "2% + 2%", body: "Direct connection with investment funds to sell your inheritance rights." },
      ],
